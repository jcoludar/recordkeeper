...
## 5. Handoff doc updated (if applicable)

If the project maintains a separate handoff doc (e.g. `NEXT_SESSION_HANDOFF.md`), update it now.

## On `ended_at:`

You don't write this field. The Stop hook fills it automatically when the session ends. Just confirm to the user that paperwork is closed.
